...
*/
        ...
        static T[] CountingSort<T>(ref T[] pole, Razeni razeni, ProgressBar p)
        {
            ...
            return vystup;  // vrátit setříděný výsledek
        }
        ...
        private void meritRazeniButton_Click(object sender, EventArgs e)
        {
            ...
            CountingSort(ref cisla, Razeni.Vzestupne, akceProgressBar);
            WriteLine(string.Format("{0}, {1}", ToString(cisla), PoleRazeni(cisla)));
            CountingSort(ref cisla, Razeni.Sestupne, akceProgressBar);
            WriteLine(string.Format("{0}, {1}", ToString(cisla), PoleRazeni(cisla)));
            WriteLine();
